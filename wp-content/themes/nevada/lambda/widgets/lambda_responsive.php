...
class WP_Widget_Responsive extends WP_Widget {
	...
	function __construct() {
		$widget_ops = array('classname' => 'lambda_widget_responsive', 'description' => __( 'Responsive On / Off Switch', UT_THEME_NAME) );
		parent::__construct('lw_responsive', __('Lambda - Responsive Switch', UT_THEME_NAME), $widget_ops);
	...
	function form($instance) { 
		...
		$buttontype = array(
			'plain' => __('Plain Text', UT_THEME_NAME),
			'button' => __('Button', UT_THEME_NAME)
		); ?>	
		
        <p>
            <label for="<?php echo $this->get_field_id('button_type'); ?>"><?php _e('Switch Layout', UT_THEME_NAME); ?>:<br />
		...
		<?php $buttoncolors = array(
			'gray' => __('gray', UT_THEME_NAME),
			'blue' => __('blue', UT_THEME_NAME),
			'green' => __('green', UT_THEME_NAME),
			'orange' => __('orange', UT_THEME_NAME),
			'purple' => __('purple', UT_THEME_NAME),
			'red' => __('red', UT_THEME_NAME),
			'coffee' => __('brown', UT_THEME_NAME),
			'pink' => __('pink', UT_THEME_NAME)
		); ?>	
		
        <p>
            <label for="<?php echo $this->get_field_id('button_color'); ?>"><?php _e('Button Color', UT_THEME_NAME); ?>:<br />
        ...
        <p>
        	<label for="<?php echo $this->get_field_id('mobile'); ?>"><?php _e('Button Text for Mobile Switch', UT_THEME_NAME); ?>:<br />
        ...
        <p>
        	<label for="<?php echo $this->get_field_id('desktop'); ?>"><?php _e('Button Text for Desktop Switch', UT_THEME_NAME); ?>:<br />
