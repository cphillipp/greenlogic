...
function lambda_table_edit() { ?>
	...
	<div id="table-items" class="tab-pane">
		...
		<?php $table_basic_columns = (empty($options['columns'])) ? lambda_table_item_array() : $options['columns'];
			...
			<label><?php _e('HTML Content', UT_THEME_NAME); ?></label><br />
			<textarea style="width:148px !important; min-width: inherit !important;" id="<?php echo $key; ?>" type="text" name="<?php echo $table; ?>[columns][<?php echo $key; ?>][column_htmltext]"/><?php echo $value['column_htmltext']; ?></textarea><br />
