...
if ( !function_exists( 'lambda_custom_css' ) ) {
	...
	function lambda_custom_css() {
		...
		$backgroundpattern = $theme_options['footer_default_backgroundpattern']['background-image'];
		$backgroundtexture = $theme_options['footer_default_backgroundtexture']['background-image'];

		if($backgroundtype == 'footer_default_backgroundpattern') {
